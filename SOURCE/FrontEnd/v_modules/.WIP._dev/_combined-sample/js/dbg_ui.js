...
function startDebugger() {
  ...
  document.querySelector("#debugContainer").appendChild(debugElem);
  ...
  debugStyle.innerHTML = `
      <style>
            ...
            .openDebugger .debugWindowTrigger {
              right: 50%;
      ...
      `;
      document.querySelector("#debugContainer").appendChild(debugStyle);
...
function toggleDebuggerVisibility() {
  ...
  if (debugWindow.classList.contains('visible')) {
    document.querySelector("#debugContainer").classList.add('openDebugger');
  } else {
    document.querySelector("#debugContainer").classList.remove('openDebugger');
  }
