...
console.log(templates.base_hero_01.view());
...
console.log(templates.base_newsletter_01.view());
...
console.log(templates.base_about_us_01.view(BAU_01));
...
// << Returns HTML filled in with data....
console.log(templates.base_hero_01.view(BH_01));
...
// << Returns HTML filled in with data....
console.log(templates.base_newsletter_01.view(BNL_01));
