const vSvgPointer = () => {
  ...
  this.customCursorString = `<svg id="customCursor" width="30px" height="30px" viewBox="0 0 20 20" class="svg-2 selected">
                            <defs>
  ...
  this.addPointer = () => {  
    document.querySelector('body').insertAdjacentHTML("afterEnd", this.customCursorString);
    this.customCursor = document.getElementById(this.config.id_string);

    window.addEventListener("mousemove", this.mouseMove);
    window.addEventListener("mousedown", this.mouseClickStart);
    window.addEventListener("mouseup", this.mouseClickStop);
  }
...
var customCursor = document.querySelector('#vSvgPointer');
